...
class UserModelCase(unittest.TestCase):
    ...
    #     u = Users(Name='Abolore Mina', Username='Abololz', Email='mina@tests.com')
    ...
    def test_posts(self):
        ...
        u2 = Users(Name='susan wilson', Username='susan', Email='susan@example.com')
        u3 = Users(Name='mary jane', Username='mary', Email='mary@example.com')
        u4 = Users(Name='david williams', Username='david', Email='david@example.com')
